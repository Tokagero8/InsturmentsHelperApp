...
import com.example.insturmentshelperapp.presenter.lessons.LessonsPlayInfoPresenter;

import java.util.List;

public class LessonsPlayInfoFragment extends Fragment implements LessonsPlayInfoInterface {

    LessonsPlayInfoPresenter presenter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_lessons_play_info, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        presenter = new LessonsPlayInfoPresenter(this, getActivity());
    ...
    public void setTimeAndPoints(int time, int points, double multipler) {
        TextView textViewInfo = getView().findViewById(R.id.text_view_lessons_play_info);
        String info1 = getString(R.string.play_info_1) + " ";
        String info2;
        String info3;
        if(time != -1){
        ...
        if(points != -1){
            info3 = getString(R.string.play_info_3a) + " " + (int)(points*multipler) + " " + getString(R.string.play_info_3b) + " ";
        } else {
    ...
    public void setContinueButton(final Lesson lesson) {
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Fragment fragment = new LessonsPlayFragment();
