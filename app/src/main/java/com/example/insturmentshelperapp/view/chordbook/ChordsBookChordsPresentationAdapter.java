...
public class ChordsBookChordsPresentationAdapter extends BaseAdapter {
    private Context context;
    List<ChordWithBitmap> items;

    public ChordsBookChordsPresentationAdapter(Context context, List<ChordWithBitmap> items){
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        @SuppressLint({"ViewHolder", "InflateParams"}) View view = LayoutInflater.from(context).inflate(R.layout.item_chords_book_chord, null);
        ...
        chordType.setText(getItem(position).getType());
