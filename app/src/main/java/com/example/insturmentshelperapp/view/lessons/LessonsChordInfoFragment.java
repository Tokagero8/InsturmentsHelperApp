...
import com.example.insturmentshelperapp.presenter.lessons.LessonsChordInfoPresenter;

import java.util.List;

public class LessonsChordInfoFragment extends Fragment implements LessonsChordInfoInterface {

    LessonsChordInfoPresenter presenter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_lessons_chord_info, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        presenter = new LessonsChordInfoPresenter(this, getActivity());
    ...
    public void setTimeAndPoints(int time, int points, double multipler) {
        TextView textViewInfo = getView().findViewById(R.id.text_view_lessons_chord_info);
        String info1 = getString(R.string.chord_info_1) + " ";
        String info2;
        String info3;
        if(time != -1){
        ...
        if(points != -1){
            info3 = getString(R.string.chord_info_3a) + " " + (int)(points*multipler) + " " + getString(R.string.chord_info_3b) + " ";
        } else {
    ...
    public void setContinueButton(final Lesson lesson) {
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Fragment fragment = new LessonsChordFragment();
