...
import com.example.insturmentshelperapp.view.lessons.LessonsNameInfoInterface;

import java.util.List;

public class LessonsNameInfoPresenter implements Presenter {

    LessonsNameInfoInterface view;
    LessonsInteractor lessonsInteractor;
    SharedPreferenceInteractor sharedPreferenceInteractor;
    ChordInteractor chordInteractor;

    public LessonsNameInfoPresenter(LessonsNameInfoInterface view, Context context){
        this.view = view;
    ...
    public void setTimeAndPoints(Lesson lesson){
        ...
        int points = LessonsIntensity.getNameLessonPoints(intensity);
